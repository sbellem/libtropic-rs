...
impl ChipId {
    ...
    pub fn print_details(&self) {
        ...
        println!(
            "MAN_FUNC_TEST: 0x{} (PASSED)",
            bytes_to_hex(&self.func_test_info)
        );
        ...
        println!(
            "Package ID: 0x{} (QFN32, 4x4mm)",
            bytes_to_hex(&self.package_type_id)
        );
        ...
        println!(
            "Prov info ver: 0x{:02x} (v{})",
            prov_info_ver, prov_info_ver
        );
        ...
        println!(
            ...
            hsm_ver[0], hsm_ver[1], hsm_ver[2], hsm_ver[3], hsm_ver[1], hsm_ver[2], hsm_ver[3]
        );
        ...
        let fab_data = u32::from_be_bytes([
            0,
        ...
        println!(
            "Prov template tag: 0x{}",
            bytes_to_hex(&self.prov_templ_tag)
        );

        let prov_spec_ver = u16::from_be_bytes(self.prov_spec_ver);
        println!(
            "Prov specification ver: 0x{:04x} (v0.{})",
            prov_spec_ver,
            prov_spec_ver & 0xff
        );

        println!(
            "Prov specification tag: 0x{}",
            bytes_to_hex(&self.prov_spec_tag)
        );
