...
mod test {
    ...
    fn test_ecc_curve_key_lengths() {
        ...
        assert_eq!(EccCurve::Ed25519.key_len(), 32, "Ed25519 key length should be 32 bytes");
        assert_eq!(EccCurve::P256.key_len(), 64, "P256 key length should be 64 bytes (uncompressed)");
    }
}
