...
mod test {
    ...
    fn test_sh0_keys() {
        ...
        let sh0priv_hex = SH0PRIV.hexify();
        let sh0pub_hex = SH0PUB.hexify();
        println!("sh0pub_hex: {}", sh0priv_hex.as_str());
        println!("sh0pub_hex: {}", sh0pub_hex.as_str());

        assert!(SH0PRIV == expected_sh0priv);
        assert!(SH0PUB == expected_sh0pub);
        assert!(SH0PRIV.hexify() == expected_sh0priv_hex);
        assert!(SH0PUB.hexify() == expected_sh0pub_hex);
    }
}
