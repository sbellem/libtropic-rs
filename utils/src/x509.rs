...
fn format_oid(oid: &Oid<'_>) -> String {
...
fn generalname_to_string(gn: &GeneralName<'_>) -> String {
    match gn {
...
pub fn print_x509_extension(oid: &Oid<'_>, ext: &X509Extension<'_>) {
    println!(
        "    [crit:{} l:{}] {}: ",
        ext.critical,
        ext.value.len(),
...
pub fn print_x509_digest_algorithm(alg: &AlgorithmIdentifier<'_>, level: usize) {
    println!(
        "{:indent$}Oid: {}",
        "",
...
pub fn print_x509_info(x509: &X509Certificate<'_>) -> io::Result<()> {
...
pub fn print_x509_signature_algorithm(signature_algorithm: &AlgorithmIdentifier<'_>, indent: usize) {
...
pub fn print_x509_ski(public_key: &SubjectPublicKeyInfo<'_>) {
...
pub fn format_number_to_hex_with_colon(b: &[u8], row_size: usize) -> Vec<String> {
